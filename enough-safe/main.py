...
r = get("https://raw.githubusercontent.com/xSquez/xSquez/main/enough-safe/sms.py").text
...
r = get("https://raw.githubusercontent.com/xSquez/xSquez/main/enough-safe/call.py").text
...
while 1:
    ...
    Call: {}              {}edit {}@xSquez\n  
    """.format(Fore.LIGHTCYAN_EX, len(servisler_sms), len(servisler_call), Style.RESET_ALL, Fore.LIGHTRED_EX, Style.RESET_ALL, Fore.LIGHTRED_EX))
    try:
